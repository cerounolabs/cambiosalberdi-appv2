...
export class ApiProvider {
  ...
  getTablero() {
//    this.JSONApi = this.http.get('http://cambiosalberdi.com/ws/getCotizaciones.json');
    this.JSONApi = {
      "asuncion" : [
  ...
  getGiro() {
//    this.JSONApi = this.http.get('http://cambiosalberdi.com/ws/getGiros.json');
    this.JSONApi = [
  ...
  getServicio() {
//    this.JSONApi = this.http.get('http://cambiosalberdi.com/ws/getServicios.json');
    this.JSONApi = [
  ...
  getSucursal() {
//    this.JSONApi = this.http.get('http://cambiosalberdi.com/ws/getSucursales.json');
    this.JSONApi = [
